...
const RentRequestDialog = ({
  ...
  console.log(state, "state in rent request dialog");
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="py-6 rounded-3xl border border-slate-200 bg-background p-0 dark:border-slate-700/60 dark:bg-slate-900 sm:max-w-md">
        <div className="p-6">
          <DialogHeader>
          ...
          <p className="mt-4 text-xs leading-relaxed text-slate-500 dark:text-slate-400">
            Sending this request will notify the landlord. You&apos;ll be
            able to proceed to payment once they approve it.
          </p>
